...
# This must match the origin (protocol + hostname + port) of your website.
# In production, this MUST be your secure HTTPS origin (e.g., "https://www.example.com").
# For local development, "http://localhost:3000" (or your Next.js dev port) is typical.
